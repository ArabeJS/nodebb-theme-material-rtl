<div component="post" class="<!-- IF posts.deleted -->deleted<!-- ENDIF posts.deleted -->" <!-- IMPORT partials/data/topic.tpl -->>
    ...
    <div class="post-block">
        ...
        <div class="post-content">
            <div class="post-body">
                <ul class="post-actions pull-left">
                    <li class="votes">
                ...
                <div class="post-header">
                    <a class="pull-right visible-xs user-profile-link" href="{config.relative_path}/user/{posts.user.userslug}">
                        <!-- IF posts.user.picture -->
                    ...
                    <span class="post-time">
                        ...
                        <span class="post-tools">
                            ...
                            <a component="post/quote" href="#" class="<!-- IF !privileges.topics:reply -->hidden<!-- ENDIF !privileges.topics:reply -->"><i class="fa fa-quote-right"></i>[[topic:quote]]</a>
                        </span>
                    </span>
                </div>
                ...
                <small component="post/editor" class="pull-left post-edit <!-- IF !posts.editor.username -->hidden<!-- ENDIF !posts.editor.username -->"><strong><a href="{config.relative_path}/user/{posts.editor.userslug}">[[global:last_edited_by, {posts.editor.username}]]</a></strong> <span class="timeago" title="{posts.editedISO}"></span></small>
                {posts.reactions}
            </div>
        </div>
    </div>
