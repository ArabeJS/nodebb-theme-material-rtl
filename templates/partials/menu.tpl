    ...
    <ul class="header-inner">
        ...
        <ul class="top-menu">
            ...
            <li class="chats dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-md pull-left" aria-labelledby="chat_dropdown">
                    <div class="listview">
            ...
            <li id="user_label" class="dropdown">
                ...
                <ul id="user-control-list" component="header/usercontrol" class="dropdown-menu pull-left" aria-labelledby="user_dropdown">
                    <li>
