		...
		<div class="col-md-10">
			<div class="card">
				...
				<div class="card-body card-padding">
					...
					<div class="form-group">
						<div class="fg-line">
							<label>[[user:aboutme]]</label> <small><label id="aboutMeCharCountright"></label></small>
					...
					<div class="form-group">
						<div class="fg-line">
							<label>[[user:signature]]</label> <small><label id="signatureCharCountright"></label></small>
