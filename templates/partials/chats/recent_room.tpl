<li component="chat/recent/room" data-roomid="{rooms.roomId}" class="lv-item media <!-- IF ../unread -->unread<!-- ENDIF ../unread -->">
    <i class="fa fa-times pull-left leave" component="chat/leave"></i>
    <!-- IF rooms.lastUser.uid -->
	<div class="lv-avatar pull-right" data-username="{rooms.lastUser.username}" data-uid="{rooms.lastUser.uid}">
