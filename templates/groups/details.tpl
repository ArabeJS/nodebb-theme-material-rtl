	...
	<div class="col-lg-5 col-xs-12">
		...
		<div class="card">
			...
			<div class="card-body card-padding members-invited">
				...
				<button class="btn btn-default btn-sm pull-left" component="groups/members/bulk-invite-button">[[groups:bulk-invite]]</button><br/><br/>
		...
		<div class="card">
			...
			<div class="card-body card-padding options collapse">
				<form component="groups/settings" role="form">
					...
					<div class="checkbox">
	                    <label>
	                        <input name="hidden" type="checbox"<!-- IF group.hidden --> checked<!-- ENDIF group.hidden -->>
	                        <i class="input-helper"></i>
					...
					<button class="btn btn-link btn-xs pull-left" type="button" data-action="delete">[[groups:details.delete_group]]</button>
