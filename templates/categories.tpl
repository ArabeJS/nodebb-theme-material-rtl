		...
		<div class="category-card" style="{function.generateCategoryBackground}">
			...
			<!-- ENDIF categories.link -->
				<div class="category-card-body">
					<ul class="category-counts pull-left">
	                    <li>
			...
			<div class="category-card-footer">
				...
				<div component="category/posts">
					<div class="pull-right hidden-xs user-avatar">
							...
							<div class="col-xs-12 col-sm-8 col-md-7 sub-category">
						    	...
						    	<div class="media-body">
						    		<div class="lv-title category-title">
										...
										<!-- ELSE -->
										<a href="{config.relatie_path}/category/{categories.children.slug}" itemprop="url">
