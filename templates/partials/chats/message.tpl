<li component="chat/message" class="lv-item media<!-- IF messages.self --> left<!-- ENDIF messages.self -->" data-index="{messages.index}" data-mid="{messages.messageId}" data-uid="{messages.fromuid}" data-self="{messages.self}" data-break="{messages.newSet}" data-timestamp="{messages.timestamp}">
    <div class="lv-avatar <!-- IF messages.self -->pull-left<!-- ELSE -->pull-right<!-- ENDIF messages.self -->">
