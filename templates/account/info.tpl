				...
				<div class="card-body card-padding">
					<ul class="list-group">
						...
						<li class="list-group-item">
							{../value}
							<small class="pull-left"><span class="timeago" title="{../timestampISO}"></span></small>
						</li>
						<!-- END usernames -->
					</ul>
				</div>
							...
							<div class="frame">
								<div class="timeline-badge">
									<a href="<!-- IF moderationNotes.user.userslug -->{config.relative_path}/user/{moderationNotes.user.userslug}<!-- ELSE -->#<!-- ENDIF moderationNotes.user.userslug -->">
	 									...
	 									<img class="user-avatar" component="user/picture" data-uid="{moderationNotes.user.uid}" src="{moderationNotes.user.picture}" align="right" itemprop="image" />
	 									<!-- ELSE -->
